...
import kotlinx.android.synthetic.main.activity_internet_paketlar.bottomNavView
import kotlinx.android.synthetic.main.activity_second.*

class InternetPaketlar : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_internet_paketlar)
        ...
        adapter.addFragment(InternetPaketlarFragment(applicationContext), "Oylik")
        ...
        btn_trafik_tekshirish.setOnClickListener {
            Toast.makeText(applicationContext, "Trafik tekshirilmoqda", Toast.LENGTH_SHORT).show()
        }
